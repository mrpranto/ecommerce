    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            <ul class="metismenu" id="side-menu">
                ...
                <li><a href="javascript: void(0);" @if (Request::is('admin/product/*/edit')) class="mm-active" @endif ><i class=" fa fa-cart-plus"></i><span class="badge badge-info badge-pill float-right">{{ App\Models\Product::count() }}</span> <span>Product</span></a>
                    <ul class="nav-second-level" aria-expanded="false">
