...
@section("page-title")
    ...
    <i class="fa fa-plus"></i> Add New Sub Sub Category
    ...
    <div class="row">
        ...
        <div class="col-sm-8 offset-md-2">
            ...
            <div class="card-box">
                ...
                <form action="{{ route('sub-sub-category.store') }}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-0 justify-content-end row">
                        <div class="col-8">
                            ...
                            <a href="{{ route('sub-sub-category.index') }}" class="btn btn-info btn-sm">
                                <i class="fa fa-list-alt"></i> Sub Sub-Category List
                            </a>
