        ...
        <div class="col-sm-12">
            ...
            <div class="card-box">
                ...
                <br>
                    ...
                    <form action="{{ route('product.update',$product->id) }}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control form-control-lg{{ $errors->has('product_name') ? ' is-invalid' : '' }}" id="product_name" name="product_name" value="{{ $product->product_name }}" placeholder="Product Name">
                            ...
                            <div class="col-6">
                                    ...
                                    <select id="category" class="form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}" onchange="get_sub_cat();" name="category_id">
                                        ...
                                        @foreach ($categories as $category)
                                            <option @if($product->category_id == $category->id) selected @endif value="{{ $category->id }}" @if(old('category_id') == $category->id) selected @endif>{{ $category->category_name }}</option>
                                        @endforeach
                            ...
                            <div class="col-6">
                                    ...
                                    <select id="sub_category" class="form-control{{ $errors->has('sub_category_id') ? ' is-invalid' : '' }}" onchange="get_sub_sub_cat();" name="sub_category_id">
                                        ...
                                        @foreach ($subcategories as $subcategory)
                                            <option @if($product->sub_category_id == $subcategory->id) selected @endif  value="{{ $subcategory->id }}">{{ $subcategory->sub_category_name }}</option>
                                        @endforeach
                                    ...
                                    <select id="sub_sub_category" class="form-control{{ $errors->has('sub_sub_category_id') ? ' is-invalid' : '' }}" name="sub_sub_category_id">
                                        ...
                                        @if ($product == true)
                                            ...
                                            @foreach ($sub_sub_categories as $sub_sub_category)
                                                <option @if($product->sub_sub__category_id == $sub_sub_category->id) selected @endif value="{{ $sub_sub_category->id }}">{{ $sub_sub_category->sub_sub_category_name }}</option>
                                            @endforeach
                                ...
                                <div class="col-6">
                                        ...
                                        <select id="brand" class="form-control{{ $errors->has('brand_id') ? ' is-invalid' : '' }}" name="brand_id">
                                            ...
                                            @foreach ($brands as $brands)
                                                <option @if($product->brand_id == $brands->id) selected @endif  value="{{ $brands->id }}">{{ $brands->brand_name }}</option>
                                            @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="tags-default">
                                    <input type="text" class="form-control" name="tags" value="{{ $product->tags }}" data-role="tagsinput" placeholder="add tags">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" id="sku" class="form-control{{ $errors->has('sku') ? ' is-invalid' : '' }}" value="{{ $product->sku }}" name="sku">
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-control{{ $errors->has('color_id') ? ' is-invalid' : '' }}" name="color_id" >
                                    ...
                                    @foreach ($colors as $color)
                                        <option @if($product->color_id == $color->id) selected @endif value="{{ $color->id }}">{{ $color->color_name }}</option>
                                    @endforeach
                            ...
                            <div class="col-4">
                                    ...
                                    <select class="form-control{{ $errors->has('size') ? ' is-invalid' : '' }}" name="size" >
                                        ...
                                        @foreach ($sizes as $size)
                                            <option @if($product->size == $size->size) selected @endif  value="{{ $size->size }}">{{ $size->size }}</option>
                                        @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                    ...
                                    <input type="number" step="0.0" name="price" id="price" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $product->price }}" placeholder="0.00">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" step="0.0" name="new_price" id="new_price" class="form-control" value="{{ $product->new_price }}" placeholder="0.00">
                        ...
                        <div class="form-group row">
                            <label for="fileUpload" class="col-3 col-form-label">Upload Product New Images <sup class="text-danger">*</sup></label>
                            <div class="col-6">
                        ...
                        <div class="form-group row">
                            <label class="col-3 col-form-label">Product Old Image</label>
                            <div class="col-9">
